...
function ShirtPage() {
    // State quản lý thanh trượt khoảng giá lọc
        ...
        <div className="bg-white min-h-screen font-sans">
            <div className="max-w-[1440px] mx-auto px-6 py-4">
                ...
                <div className="text-xs text-zinc-500 mb-6 flex items-center gap-1">
                    ...
                    <span className="text-black font-semibold">Áo</span>
                </div>

                {/* 2. THÂN TRANG BỘ LỌC & LƯỚI SẢN PHẨM */}
...
<div className="mb-6 pb-6 border-b border-zinc-200">
    ...
    <div className="flex flex-wrap gap-2">
        ...
        {/* Ô màu Trắng - vuông bo góc nhẹ, có dấu tích */}
                            ...
                            {SHIRTS.map((product) => (
                                <Link to={`/product/${product.id}`} key={product.id} className="group flex flex-col">
                                    ...
                                    <div className="relative overflow-hidden bg-[#f9f9f9]">
                                        {/* Hiển thị nhãn PREMIUM chuẩn xác cho những sản phẩm được thiết lập */}
                                        ...
                                        <img
                                            src={product.image}
                                            alt={product.name}
                                            className="h-[430px] w-full object-cover transition duration-500 group-hover:scale-102"
                                        />
                                    </div>

                                    {/* Chi tiết thông tin sản phẩm */}
                                    <div className="mt-4 flex flex-col flex-grow">
                                        {/* Dòng mác phân loại sản phẩm (Mando Basic, Ethnic Series...) */}
                                        ...
                                        {/* Giá tiền gốc và giá giảm (nếu có) */}
